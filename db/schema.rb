...
ActiveRecord::Schema.define(version: 2023_01_18_060540) do
  ...
  create_table "cat_coffee_shop_comments", force: :cascade do |t|
  ...
  create_table "cat_coffee_shop_favorites", force: :cascade do |t|
    t.integer "customer_id", null: false
    t.integer "cat_coffee_shop_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
